...
Page({
    ...
    getPhoneNumber: function (event) {
        getApp().methods.login({ event, crmEventFormSID: this.data.crmEventFormSid, suffix: {suffix: this.data.suffix, suffixStr: this.data.suffixStr}, remark: this.data.crmRemark, callback: ({ phone, openid }) => this.setData({ phone, openid }, this.savePhoto())});
    },
