Page({
    ...
    webViewPage: function() {
      this.setData({
        src: `${getApp().globalData.config.apis.base.replace("/wechat/mini-program","")}/agreement/privacy?type=html`
      });
    },
    ...
    richText: function() {
      ...
      wx.request({
          url: `${getApp().globalData.config.apis.base.replace("/wechat/mini-program","")}/agreement/privacy?type=json`,
          success: res => {
